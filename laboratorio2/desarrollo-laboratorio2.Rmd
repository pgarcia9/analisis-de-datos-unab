...
1. Algebraicamente
2. En Excel (el archivo con los datos es <a href="http://pachamaltese.github.io/econometria/pregunta1-laboratorio2.xlsx">pregunta1-laboratorio2.xlsx</a>)
3. En R
...
####Excel
Ver archivo <a href="http://pachamaltese.github.io/econometria/desarrollo-pregunta1-laboratorio2.xlsx">desarrollo-pregunta1-laboratorio2.xlsx</a>
...
##Pregunta 4
A partir del archivo Excel utilizado en el Laboratorio 1 (<a href="http://pachamaltese.github.io/econometria/laboratorio1.xlsx">laboratorio1.xlsx</a>) obtenga las mismas regresiones (con y sin constante) utilizando R. Para esto siga los siguientes pasos:
