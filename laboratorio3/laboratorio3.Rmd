...
* Ejemplo: $X$ es la estatura en $m$ e $Y$ es el peso en $kg$. Entonces $\beta_1$ es $kg/m$. Convirtiendo $X$ en $cm$ implica multiplicar $X$ por $100 cm/m$. Para obtener $\beta_1$ en las unidades correctas, tenemos que dividir por $100 cm /m$ y así se tendrán las unidades correctas. 
$$
...
* ¿Cuál es el efecto de las variables más importantes sobre la varible MPG? De una interpretación simple de cada una de las variables (e.g. si la variable $X_j$ aumenta en $a$ unidades se espera que la variable $Y$ aumente/disminuya $b$ unidades)
